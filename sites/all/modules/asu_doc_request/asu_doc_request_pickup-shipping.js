(function ($) {
  Drupal.behaviors.asu_doc_request = {
    ...
    // If a form change occurs in paper transcripts shipping service radios.
      ...
      $('#edit-commerce-shipping-shipping-service-commerce-pickup-node-4').change(function() {
        $('fieldset#edit-customer-profile-shipping').hide();
      });

      $('#edit-commerce-shipping-shipping-service-commerce-pickup-node-5').change(function() {
        $('fieldset#edit-customer-profile-shipping').hide();
      });
